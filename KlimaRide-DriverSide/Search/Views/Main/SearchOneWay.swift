...
struct SearchOneWay: View {
    ...
    var body: some View {
        ...
        .padding(.top)
//        .onAppear {
//            print("eventNameField: \(onewaySearchPost.eventNameField)")
//            onewaySearchPost.oneWayRide()
//        }
    }
}

struct SearchOneWay_Previews: PreviewProvider {
    static var previews: some View {
        let mockSearchRide = SearchPostAPiMethod()
             mockSearchRide.eventNameField = "Sample Event"
             
        return SearchOneWay(searchPost: mockSearchRide)
