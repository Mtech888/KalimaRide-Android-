    ...
    var body: some View {
        ZStack {
            VStack(spacing: 20) {
                ...
                HStack(spacing: 20) {
                    CustomTextFeild(fieldBinding: $ridePostApi.returningDate, title: "Returning Date", placeholder: "Select Date", icon: "date-icon")
                    Text("at")
                        .padding(.top)
                        .font(.custom(Font.regular, size: 13))
                    CustomTextFeild(fieldBinding: $ridePostApi.returningTime, title: "", placeholder: "Select Time", icon: "time-iconGreen")
                        .padding(.top, 10)
                }
...
struct ReturnRide_Previews: PreviewProvider {
